...
static int video_libcamera_parse(Videodev *vd, QemuOpts *opts, Error **errp)
{
...
static void video_libcamera_class_init(ObjectClass *oc, void *data)
{
    VideodevClass *vc;
    ...
    vc->parse = video_libcamera_parse;
}
